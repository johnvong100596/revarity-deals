...
export default function BudgetClient({ budgetMonthly, kpi, angles }) {
  ...
  return (
    <>
      ...
      <p className="lead">{angles.length > 0 ? "Set the monthly plan and split it across themes. We work out your target leads from your cost per lead ceiling — planning numbers only." : "Set the monthly plan. We work out your target leads from your cost per lead ceiling — planning numbers only."}</p>
      <div className="row">
      ...
      {/* Theme presets are parked (ANGLES_ENABLED) — an empty list hides the split; budget stays whole-account. */}
      {angles.length > 0 && (
        <>
