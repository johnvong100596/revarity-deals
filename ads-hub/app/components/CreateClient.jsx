    ...
    <>
      ...
      <div className="composer">
        ...
        <div className="composer-foot">
          <span className="hint">{output === "auto" ? "Auto: the studio plans the shots and routes engines — you approve before anything posts (D-04)." : "We create these now and send them to your approvals."}</span>
